...
export default function CheckoutPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <h1 className="text-4xl font-semibold text-ink">Confirm your personalized order</h1>
      <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_360px]">
        <form action={submit} className="rounded-lg border border-black/10 bg-white p-5">
          ...
          <fieldset className="mt-6 rounded-lg border border-black/10 bg-linen p-4">
            <legend className="px-2 text-sm font-semibold text-ink">Payment method / Betaalmethode</legend>
            <label className="mt-3 flex cursor-pointer items-center gap-3 rounded-md bg-white p-3">
        ...
        <aside className="h-fit rounded-lg bg-ink p-5 text-white">
